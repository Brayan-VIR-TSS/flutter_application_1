...
class _RoutePageState extends State<RoutePage> {
  ...
  try {
    FirebaseFirestore.instance
        ...
        .snapshots()
        .listen((snapshot) {
      _routeCoordinates.clear(); // Limpiar las coordenadas antes de añadir nuevas
      ...
      setState(() {
        ...
        _isDataLoaded = true; // Actualizar el estado después de cargar los datos
      });
    });
  } catch (e) {
    ...
    setState(() {
      ...
      _isDataLoaded = true; // Para evitar que la pantalla quede en espera indefinida
      print("Datos de la ruta: $_routeCoordinates");
